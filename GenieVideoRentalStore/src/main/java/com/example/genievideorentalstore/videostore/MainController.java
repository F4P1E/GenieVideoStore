...
import com.example.genievideorentalstore.model.ImageTextCell;
import com.example.genievideorentalstore.model.ProductQueries;
...
public class MainController {
    ...
    public MainController(Stage warningStage, Stage helpStage) {
    ...
    public void showHelp(ActionEvent event) {
        ...
        alert.getDialogPane().setContentText("Genie Video Rental Store is an e-store where a user can buy videos digitally and then play them from the Video Library. The user can browse through the available video clicking each item on the list. Then he can add the selected video to the Shopping Cart and proceed to Payment. Each video can be purchased only once due to its linking with the user's account.");
        alert.getDialogPane().setHeaderText(null);

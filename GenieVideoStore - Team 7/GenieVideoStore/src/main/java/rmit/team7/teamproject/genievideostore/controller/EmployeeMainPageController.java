...
public class EmployeeMainPageController {
    ...
    private static final String FILE_PATH_LOGOUT = "rmit/team7/teamproject/genievideostore/images/exit.png";
    private static final String FILE_PATH_USER = "rmit/team7/teamproject/genievideostore/images/user.png";
    ...
    public static void show() {
        try {
            ...
            loaderEmployee.setLocation(Main.class.getResource("rmit/team7/teamproject/genievideostore/employeeMainPage.fxml"));
